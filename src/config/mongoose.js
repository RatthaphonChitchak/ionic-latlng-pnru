...
module.exports.connection = function (cb) {
    var MONGODB_URI = process.env.MONGO_DB_URI || process.env.MONGODB_URI || process.env.MONGODB_URI_TEST || "mongodb+srv://covid19_01:PP2537wkd@covid19.ivklh.mongodb.net/coivid19?retryWrites=true&w=majority"
